...
if __name__ == "__main__":
    ...
    parser.add_argument("--weights_path", type=str, help="Path to the weights file", default="/Users/almondgod/Repositories/robopianist/checkpoints/20250107_175543/checkpoint_episode_2600.pt")
